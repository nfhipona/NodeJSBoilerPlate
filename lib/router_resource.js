...
module.exports = (app, socket, database, auth) => {
    ...
    app.get     ('/roles/:id',                                      auth.verifyWithType('user_token'),              acl('resource', 'r'),                                           role.fetch_one                          );
    app.get     ('/roles',                                          auth.verifyWithType('user_token'),              acl('resource', 'r'),                                           role.fetch_multiple                     );
    app.delete  ('/roles/:id',                                      auth.verifyWithType('user_token'),              acl('resource', 'd'),                                           role.remove                             );
