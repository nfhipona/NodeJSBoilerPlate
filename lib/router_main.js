...
module.exports = (api, database, auth) => {
    ...
    api.post    ('/users/accounts',                                 is_maintenance,                                 auth.verifyToken(c.USER_TOKEN),                             user.create_account);
    api.put     ('/users/accounts',                                 is_maintenance,                                 auth.verifyToken(c.USER_TOKEN),                             user.update_account);
